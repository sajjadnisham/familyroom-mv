...
assets/img/*.svg        20 generated vector illustrations (drawn, not photographs)
...
**Illustrations, not photographs.** Every image is vector artwork generated by `tools/make-art.py`
(`python3 tools/make-art.py` to regenerate). This is deliberate: the café's and its guests'
Instagram and Facebook photos are their copyright, and the audit is explicit that reusing them
